...
<body>
	...
	<div style="margin-left:25%;padding:1px 16px;height:100%;">
		<p style="font-size:30px; font-weight:bold;" >Room Booking has been cancelled successfully.<br></p>
		<P style="font-size:25px; ">Click Next to get redirected to home.</P>
		<a href="user_view.php" style=" text-align: center; color: white; border: 3px solid #e6b800; background-color: rgb(52, 53, 54);">Next</a>
	</div>
</body>
